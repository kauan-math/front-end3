  ...
  async function handleAlterarSenha(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/funcionarios/${funcionario.id}/senha`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      console.error(err);
      setSenhaErro(
        "Não foi possível conectar ao servidor para alterar a senha.",
      );
    }
  }
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">
              Acompanhe alunos, gerencie treinos e consulte suas preferências
              operacionais.
            </p>
          </div>
          ...
          >
            ...
            {alunosFiltrados.length > 5 && (
              ...
              >
                {mostrarTodosAlunos
                  ? "Mostrar menos"
                  : `Ver todos (${alunosFiltrados.length})`}
              </button>
            )}
          </SectionCard>
